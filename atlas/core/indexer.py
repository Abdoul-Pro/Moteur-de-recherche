...
class TFIDFIndexer:
    ...
    def build_index(
        ...
        if not texts:
            raise ValueError("Aucun document avec contenu valide.")
        ...
        try:
            ...
            raise ValueError(f"Erreur lors de la vectorisation : {e}") from e
    ...
    def save(self, filepath: Optional[Path] = None) -> Path:
        if not self._is_built:
            raise RuntimeError("Impossible de sauvegarder : index non construit.")
