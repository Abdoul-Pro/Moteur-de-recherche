"""
home.py — Page d'accueil de l'interface Windows.
"""
...
from windows.components.widgets import StatCard, SearchBar

_LOGO_PATH = Path(__file__).resolve().parent.parent.parent / "assets" / "icons" / "logo.png"
...
class HomePage(ctk.CTkFrame):
    ...
    def _build_header(self, parent):
        ...
        try:
            ...
            _logo = ctk.CTkImage(light_image=_img, dark_image=_img, size=(120, 120))
            ctk.CTkLabel(header, image=_logo, text="").grid(
