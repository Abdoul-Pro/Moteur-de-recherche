"""
about.py — Page À propos de l'interface Windows.
"""
...
class AboutPage(ctk.CTkFrame):
    def __init__(self, parent, **kwargs):
        ...
        try:
            ...
            _logo = ctk.CTkImage(light_image=_img, dark_image=_img, size=(100, 100))
            ctk.CTkLabel(about_card, image=_logo, text="").grid(
